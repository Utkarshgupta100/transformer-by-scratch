...
This repository contains an implementation of the Transformer architecture from scratch.
...
## Architecture
The Transformer architecture consists of a set of encoders and a decoders.
